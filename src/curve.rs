    ...
    + From<<Self as PrimeCurve>::Affine>
{
    ...
    /// Variable-time mixed addition (Projective + Affine).
    /// Uses madd-1998-cmo-2 formula (9M+2S) vs complete RCB (~12-18M).
    /// Handles identity self and same-x fallback internally.
